    ...
    <aside class="lg:sticky lg:top-5 lg:self-start">
        <div class="border border-[#D6C0A8] bg-[#1F1B16] p-5 text-white shadow-[10px_10px_0_rgba(31,27,22,0.10)]">
            ...
            <div class="mt-8 space-y-2">
                <a href="/admin/dashboard" class="flex items-center justify-between bg-white px-4 py-3 text-sm font-black text-[#1F1B16]">
                    Dashboard
    ...
    <main class="space-y-5">
        <header class="border border-[#D6C0A8] bg-[#FFF9F1] p-6 shadow-[10px_10px_0_rgba(31,27,22,0.08)]">
            <div class="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
                <div>
                    <p class="text-sm font-bold uppercase tracking-[0.3em] text-[#C64E00]">Admin dashboard</p>
                    <h1 class="mt-3 text-4xl font-black tracking-tight text-[#1F1B16]">Product operations</h1>
                    <p class="mt-3 max-w-2xl text-base leading-7 text-[#6A4A2D]">Review inventory, open product records, and create new listings from one focused workspace.</p>
                </div>
