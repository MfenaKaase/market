<section class="border border-[#DDC8B0] bg-white p-5 shadow-[10px_10px_0_rgba(35,27,19,0.08)]">
    <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="relative w-full sm:max-w-xl">
            ...
            />
            <button type="button" class="absolute right-2 top-2.5 inline-flex h-11 items-center justify-center bg-[#1F1B16] px-5 text-sm font-semibold text-white transition hover:bg-[#FF7A18]">Search</button>
        </div>
    </div>
